---
title: "Reporte regresión lineal"
...
Guardamos con el knit
Y borramos casi todo menos lo de arriba
...
## Datos
A continuación se muestran los datos de calificaciones de cálculo y matemáticas
...
plot(error, col="#0d47a1", type = "o", 
     xlab = "Índice de Observación",
     ylab = "Valor de Error",
     main = "Gráfico de Errores")
     lines(1:n, rep(0,n), col="#df3e3e")# 1:n es una secuencia, empieza en 1, termina en n
...
# Shapiro #
shapiro.test(error) # Para n ≤ 30
# Como el pvalor ≥ α, no rechazo H0, no hay evidencia que no garantice que no son normales
# A lo mejor los datos son normales
# Si el pvalor ≤  α, no son normales


# Anderson-Darling #
# install.packages("nortest")
library(nortest)
ad.test(error) #siempre nos quedamos con el p-valor que sea más grande, para que sea más contuntente rechazar


# Lilline # 
lillie.test(error) # Para n ≥ 30
